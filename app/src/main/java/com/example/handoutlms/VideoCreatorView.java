                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (Array_fileURL.isEmpty()){
                            ...
                            VideoLinkAdapter videoLinkAdapter = new VideoLinkAdapter(VideoCreatorView.this, group_name, Array_fileURL, Array_fileDescription, Array_thumbnail, Array_fileName, Array_resID, "creator");
