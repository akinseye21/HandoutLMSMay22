...
//                startActivity(i);
    ...
    class Adapter extends RecyclerView.Adapter<Adapter.MyHolder> {
        ...
        public Adapter.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(CreateGig6.this).inflate(R.layout.list_gig_category, parent, false);
    ...
    private void createNotificationChannel() {
        ...
        Intent notificationIntent = new Intent(CreateGig6.this, VideoCreatorView.class);
        ...
        NotificationManagerCompat m = NotificationManagerCompat.from(CreateGig6.this);
