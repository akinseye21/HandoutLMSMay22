 ...
 * {@link ViewCourses.OnFragmentInteractionListener} interface
...
public class ViewCourses extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_view_courses, container, false);
        bck = v.findViewById(R.id.back);
        bck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //load view tutorial group fragment
    ...
    private void loadFragment(Fragment fragment) {
        ...
        fragmentTransaction.replace(R.id.frame_view_courses, fragment);
