...
public class TodayTaskAdapter2 extends BaseAdapter {
    ...
    public TodayTaskAdapter2(Context applicationContext, ArrayList<String> task_name, ArrayList<String> task_date, ArrayList<String> task_category, ArrayList<String> task_description, ArrayList<String> task_time ){
