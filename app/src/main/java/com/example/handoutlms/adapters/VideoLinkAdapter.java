...
import com.example.handoutlms.activities.EditResources;
...
public class VideoLinkAdapter extends BaseAdapter {
    ...
    public VideoLinkAdapter(Context applicationContext, String groupName, ArrayList<String> arr_fileUrl, ArrayList<String> arr_fileDescription, ArrayList<String> arr_thumbnail, ArrayList<String> arr_fileName, ArrayList<String> arr_resID, String from, String mode){
